...
<title>쪽지함</title>
   ...
   <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css">
	...
	function fncGetUserList(currentPage, messageNo) {
		$("#currentPage").val(currentPage);
		$("form").attr("method" , "POST").attr("action" , "/user/listMessage").submit();
	}
	
	function fncDeleteMessage(currentPage) {
	...
	$(function() {
		...
		$( "#asc" ).on("click" , function() {
			self.location="/user/listMessage?searchCondition=1&searchMenu="+$("#searchMenu").val();
		});
